...
public class JFCadastroCliente extends JFrame {
	...
	public JFCadastroCliente() {
		...
		textField_6.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				 limiteCredito = textField.getText();
			}
		});
		...
		JLabel lblLimiteCred = new JLabel("Limite cred..");
	...
	void btn() {
		...
		try {
			...
			limitCred = Double.parseDouble(limiteCredito);
			...
			Cliente clientes = new Cliente(code, nome, telefone, email, dataCad, cpf, limitCred);
