...
public class JFCadastroVendedor extends JFrame {
	...
	public JFCadastroVendedor() {
		...
		JLabel lblLimiteCred = new JLabel("Meta Mensal");
	...
	void btn() {
		...
		try {
			...
			meta = Double.parseDouble(metaMensal);
			...
			Vendedor vendedores = new Vendedor(code, nome, telefone, email, dataCad, cpf, meta);
